<?php
  ...
  * Slug: newsgrove/blog-full-width
  */
?>
...
<h1 class="wp-block-heading has-text-align-center has-link-color-color has-text-color has-link-color"><?php echo esc_html__( 'Articles', 'newsgrove' ); ?></h1>
<!-- /wp:heading --></div></main>
<!-- /wp:cover -->
