...
<h1 class="wp-block-heading has-text-align-center has-link-color-color has-text-color has-link-color"><?php echo esc_html__( 'Blog Left Sidebar', 'newsgrove' ); ?></h1>
<!-- /wp:heading --></div></main>
<!-- /wp:cover -->
...
<div class="wp-block-columns"><!-- wp:column {"width":"33.33%","className":"sticky-sidebar","style":{"spacing":{"padding":{"left":"0"}}}} -->
